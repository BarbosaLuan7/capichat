...
const AudioPlayerComponent = forwardRef<HTMLDivElement, AudioPlayerProps>(
  ({ src, className, 'aria-label': ariaLabel }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'flex min-w-[200px] items-center gap-2 rounded-lg bg-muted/50 p-2',
          className
        )}
        role="region"
        aria-label={ariaLabel || 'Player de áudio'}
      >
