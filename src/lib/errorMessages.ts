  ...
  if (error && typeof error === 'object') {
    ...
    if (err.status) {
      switch (err.status) {
        ...
        case 401: return 'Você precisa fazer login para continuar.';
        case 403: return 'Você não tem permissão para realizar esta ação.';
        case 404: return 'Registro não encontrado.';
        case 409: return 'Conflito ao salvar. O registro pode já existir.';
        case 413: return 'O arquivo é muito grande.';
        ...
        case 504: return 'Tempo limite excedido. Tente novamente.';
      }
    }
  }
