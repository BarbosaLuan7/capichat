...
export const canViewReports = (role: AppRole): boolean =>
  hasPermission(role, 'view_reports') || role === 'admin';
...
export const ROLE_DESCRIPTIONS: Record<AppRole, string> = {
  admin:
    'Acesso completo. Permite ao usuário alterar todas as configurações do sistema e visualizar todos os atendimentos, sem restrições.',
  manager:
    'Acesso de gerente. Permite gerenciar equipes, visualizar relatórios e supervisionar atendimentos.',
  agent:
    'Acesso com limitações. Permite visualizar indicadores e configurações, e interagir com os atendimentos das equipes sob sua responsabilidade.',
